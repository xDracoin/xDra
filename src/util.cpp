...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\xDra
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\xDra
    // Mac: ~/Library/Application Support/xDra
    // Unix: ~/.xDra
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "xDra";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "xDra.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "xDrad.pid"));
