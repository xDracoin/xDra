...
#define POOL_STATUS_FINAxDraE_TRANSACTION       4 // master node will broadcast what it accepted
...
{
public:
    /// Is the inputs associated with this public key? (and there is 5000 xDra - checking if valid masternode)
