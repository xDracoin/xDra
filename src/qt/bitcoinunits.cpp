...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("xDra");
    case mBTC: return QString("mxDra");
    case uBTC: return QString::fromUtf8("μxDra");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("xDra");
    case mBTC: return QString("Milli-xDra (1 / 1,000)");
    case uBTC: return QString("Micro-xDra (1 / 1,000,000)");
    default: return QString("???");
    }
}
