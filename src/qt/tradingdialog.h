...
private slots:
    ...
    QString BuyxDra(QString OrderType, double Quantity, double Rate);
    QString SellxDra(QString OrderType, double Quantity, double Rate);
