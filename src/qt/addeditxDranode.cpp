#include "addeditxDranode.h"
#include "ui_addeditxDranode.h"
...
AddEditxDraNode::AddEditxDraNode(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AddEditxDraNode)
{
    ui->setupUi(this);
    ...
    ui->txhashLineEdit->setPlaceholderText("Enter your 500 xDra TXID");
...
AddEditxDraNode::~AddEditxDraNode()
{
    delete ui;
}


void AddEditxDraNode::on_okButton_clicked()
{
...
void AddEditxDraNode::on_cancelButton_clicked()
{
    reject();
}

void AddEditxDraNode::on_AddEditAddressPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->addressLineEdit->setText(QApplication::clipboard()->text());
}

void AddEditxDraNode::on_AddEditPrivkeyPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->privkeyLineEdit->setText(QApplication::clipboard()->text());
}

void AddEditxDraNode::on_AddEditTxhashPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
