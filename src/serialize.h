...
#ifndef BITCOIN_SERIAxDraE_H
#define BITCOIN_SERIAxDraE_H
...
#define IMPLEMENT_SERIAxDraE(statements)    \
 ...
 * code. Adding "ADD_SERIAxDraE_METHODS" in the body of the class causes these wrappers to be
 * added as members.
 */
#define ADD_SERIAxDraE_METHODS                                                          \
...
//
// Support for IMPLEMENT_SERIAxDraE and READWRITE macro
//
